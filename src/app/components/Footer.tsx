            ...
            <div className="w-full h-auto bg-primaryDark px-4 pt-12 pb-8">
                <div className="container mx-auto  grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <table className="w-full align-top text-white overflow-hidden text-sm md:text-base">
                            <tbody>
                                ...
                                <tr className="align-top">
                                    ...
                                    <td className="align-top"> : </td>
                                    <td className="pl-4 align-top">
                                        Jl. Bangsring Under Water, Kemanduran, Bangsring, Kec. Wongsorejo, Kabupaten Banyuwangi, Jawa Timur 68453
                                    </td>
                                </tr>
                                <tr className="align-top">
                                    ...
                                    <td className="align-top"> : </td>
                                    <td className="pl-4 align-top">
                                        <a href="https://www.instagram.com/banyuwangidivingschool/" target="_blank" rel="noopener noreferrer">
                    ...
                    <div className="text-accent sm:w-full">
                        ...
                        <div className="flex flex-col items-start  text-sm md:text-base">
                            <div className="flex flex-col items-center w-full">
                                <img src="/padi.png" alt="Padi" className="w-1/2 pt-4 pb-4" />
                                <p className='text-sm text-white text-center'>The Professional Association of Diving Instructors</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="text-accent overflow-hidden w-auto">
                        ...
                        <h3 className="text-white pt-2 pb-4  text-sm md:text-base">Jl. Bangsring Under Water, Kemanduran, Bangsring, Kec. Wongsorejo, Kabupaten Banyuwangi, Jawa Timur 68453</h3>
                        <Map />
                    </div>
